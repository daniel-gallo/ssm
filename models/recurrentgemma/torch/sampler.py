...
import models.recurrentgemma.torch.griffin as griffin_lib
from models.recurrentgemma import common
from models.recurrentgemma.torch import array_typing as at
...
class Sampler:
    ...
    def __init__(
        ...
        self._eos_token = torch.tensor(
            [self.vocab.eos_id()], device=self.device
        )
