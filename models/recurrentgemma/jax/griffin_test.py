...
from models.recurrentgemma.jax import griffin
        ...
        for i, block_type in enumerate(block_types):
            ...
            match block_type:
                case common.TemporalBlockType.RECURRENT:
                    assert isinstance(
                        block_cache, griffin.modules.RecurrentBlockCache
                    )
                    self.assertEqual(
                ...
                case common.TemporalBlockType.ATTENTION:
                    assert isinstance(
                        block_cache, griffin.modules.AttentionBlockCache
                    )
                    self.assertEqual(
                    ...
                    self.assertEqual(
                        block_cache.num_tokens.shape, (batch_size,)
                    )
